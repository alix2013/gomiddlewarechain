...
func main() {
	...
	http.HandleFunc("/login", gomiddlewarechain.ChainHandlerFunc(middleware.AllowedHttpMethod("POST"), LoginHandler))
	http.HandleFunc("/protect", gomiddlewarechain.ChainHandlerFunc(middleware.AllowedHttpMethod("GET"), middleware.DefaultJWTHandlerFunc(signkey, contextTokenKey), ProtectedHandler))
	http.HandleFunc("/public", gomiddlewarechain.ChainHandlerFunc(middleware.AllowedHttpMethod("GET"), publicHandler))
	...
	/*
		...
		jwtmiddleware := middleware.NewDefaultJWTMiddleware(signkey, contextTokenKey, []string{"/login", "/public"})
